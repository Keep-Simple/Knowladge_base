package basics.BaseCourse.JavaNIO.FileSystem.PathesAndCopying;
...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            Path sourceFile = FileSystems.getDefault().getPath("C:\\Users\\Chill Nick\\IdeaProjects" +
                    "\\Learning\\src\\basics\\UdemyBaseCourse\\JavaNIO\\FileSystem\\Second\\file1.txt");
            Path copyFile = FileSystems.getDefault().getPath( "src","basics", "UdemyBaseCourse", "file2copy.txt");
