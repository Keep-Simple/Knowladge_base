package basics.BaseCourse.JavaNIO.FileSystem.FileAttributes;
...
//            Files.createDirectories(dirToCreate);
            ...
            Path filePath = FileSystems.getDefault().getPath("src","basics","UdemyBaseCourse","JavaNIO",
                    "FileSystem","First", "file1.txt");
